...
urlpatterns = [
    ...
    path("profile/upload-profile-picture/", views.ProfilePictureUploadView.as_view(), name="upload-profile-picture"),
    ...
    path("admin/users/<uuid:user_id>/role/", views.ChangeUserRoleView.as_view(), name="change-user-role"),
